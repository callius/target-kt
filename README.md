...
/**
 * Function generated by the processor.
 */
 ...
 */
fun updateModel(repository: ModelRepository, id: ModelId, builder: ModelBuilder) {
...
2. Convert to compiler plugin and remove the need for `companion object` stubs once compiler plugin inference is
   available in Kotlin 2.x.
